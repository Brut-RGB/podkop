...
REPO="https://api.github.com/repos/Brut-RGB/podkop/releases/latest"
...
update_config() {
    ...
    while true; do
            ...
            yes|y|Y)
                ...
                wget -O /etc/config/podkop https://raw.githubusercontent.com/Brut-RGB/podkop/refs/heads/main/podkop/files/etc/config/podkop
...
main() {
    ...
    if command -v curl >/dev/null 2>&1; then
        check_response=$(curl -s "https://api.github.com/repos/Brut-RGB/podkop/releases/latest")
